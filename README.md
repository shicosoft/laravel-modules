...
``` php
'providers' => [
  Koyeo\Modules\LaravelModulesServiceProvider::class,
],
```
...
``` php
'aliases' => [
  'Module' => Koyeo\Modules\Facades\Module::class,
],
```
...
``` bash
php artisan vendor:publish --provider="Koyeo\Modules\LaravelModulesServiceProvider"
```
